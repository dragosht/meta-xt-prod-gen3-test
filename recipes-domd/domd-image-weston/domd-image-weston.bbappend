...
SRC_URI = " \
    repo://github.com/xen-troops/manifests;protocol=https;branch=refs/tags/v7.0;manifest=${XT_MANIFEST_FOLDER}/domd.xml;scmdata=keep \
"
...
XT_QUIRK_PATCH_SRC_URI_rcar = "\
    ...
    file://0001-Add-vspfilter-config-for-h3ulcb-4x2g-machine.patch;patchdir=meta-renesas \
